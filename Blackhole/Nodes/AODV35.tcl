...
set val(x)      2235                       ;# X dimension of topography
...
set tracefile [open AODV35.tr w]
$ns trace-all $tracefile
$ns use-newtrace

#Open the NAM trace file
set namfile [open AODV35.nam w]
...
$ns at 0.5 "[$n2 set ragent_] blackhole"
$ns at 0.8 "[$n15 set ragent_] blackhole"
#===================================
#        Agents Definition        
#===================================
